...
interface RendererOptions extends Partial<LaunchOptions> {
    skipThirdPartyRequests?: any;
    consoleHandler?: any;
    viewport?: any;
    renderAfterDocumentEvent?: any;
    navigationOptions?: any;
    maxConcurrentRoutes?: null | number,
    inject?: any; // TBD
...
class PuppeteerRenderer {
  ...
  async renderRoutes (routes, Prerenderer) {
    ...
    const limiter = promiseLimit(this._rendererOptions.maxConcurrentRoutes ?? 0)
